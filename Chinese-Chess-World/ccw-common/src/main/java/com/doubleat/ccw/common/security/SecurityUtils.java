package com.doubleat.ccw.common.security;

import com.doubleat.ccw.common.constant.SecurityConstant;
...
public class SecurityUtils {
    ...
    public static HttpCookie createAuthCookie(String accessToken, Long accessTokenValidityInMilliseconds) {
        return ResponseCookie
                .from(SecurityConstant.ACCESS_TOKEN_COOKIE, accessToken)
                .httpOnly(true)
                .secure(false)
                //                .sameSite("")
    ...
    private static String getTokenFromCookie(Cookie... cookies) {
        ...
        for (Cookie cookie : cookies) {
            if (SecurityConstant.ACCESS_TOKEN_COOKIE.equals(cookie.getName())) {
